...
- Cada superficie activa tiene un grupo de strings G1: elegir Inversor, MPPT (número de entrada del inversor), N serie y N paralelo. Junto a la superficie aparece «Rango válido de N serie con <panel>: a–b», calculado con la ficha y las temperaturas de diseño. El tipo dedicado/compartido se deriva solo. Varias superficies en un mismo inversor van en MPPT distintos si llevan paneles distintos.
