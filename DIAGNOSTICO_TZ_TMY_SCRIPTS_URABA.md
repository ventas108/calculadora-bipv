...
4. ~~¿Motor real sin IAM vs con IAM?~~ → Confirmado: sin IAM +3,1% vs PVsyst; con IAM (Motor Óptico) −0,70%. La brecha era casi enteramente el IAM faltante. Pendiente decidir: ¿actualizar el flujo recomendado del manual para incluir Motor Óptico en proyectos agrivoltaicos, y/o recalcular los entregables con 336.662 kWh/año (más preciso que 334.846)?
